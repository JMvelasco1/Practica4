...
export default function TaskForm({
  ...
  const loadUsers = async () => {
    try {
      ...
      users.value = Array.isArray(usersData?.data) ? usersData.data : []; 
    } catch (err) {
      ...
      <form onSubmit={handleSaveTask}>
        ...
        <div class="form-group">
          ...
          > 
            ...
            <option value={TaskStatus.PENDING /*EL ENUM ESTABA MAL*/}>Pending</option>
            <option value={TaskStatus.IN_PROGRESS}>In progress</option>
            <option value={TaskStatus.COMPLETED /*EL ENUM ESTABA MAL */}>Completed</option> 
          </select> 
        </div>
        ...
        <div class="flex justify-end gap-2 mt-4">
          ...
          <button
           ...
           // disabled={isLoading.value} se comenta para que parezca el saving al hacer el submit
          >
            {isLoading.value
              ? "Saving..."
